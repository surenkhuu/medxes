          ...
          modules: [
              {
                  name: 'dndLists',
                  files: [
                      'vendor/modules/angular-drag-and-drop-lists-master/angular-drag-and-drop-lists.min.js'
                  ]
              },
              {
                  name: 'ngGrid',
              ...
              },
              {
                  ...
                  files: [
                      ...
                      'vendor/modules/angular-ui-grid/ui-grid.bootstrap.css',
              ...
              },
              {
              ...
              },
               {
                  ...
                  files: [
                     'vendor/modules/pdfmake/build/pdfmake.min.js'
                     , 'vendor/modules/pdfmake/build/vfs_fonts.js'
                  ]
              },
              {
                  name: 'xeditable',
              ...
              },
              {
                  ...
                  files: [
                      'vendor/modules/barcodeGenerator/barcode.css',
                      'vendor/modules/barcodeGenerator/barcodeGenerator.js'
                  ]
              },
              {
                  name: 'dynform',
                  files: [
                      'vendor/modules/angular-dynforms/dynamic-forms.js'
                  ]
              },
              {
                  name: 'ui.select',
